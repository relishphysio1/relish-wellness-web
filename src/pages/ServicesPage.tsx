...
const services = [
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1518770660439-4636190af475?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80", // Circuit board macro: implies medical equipment, as closest possible
    altText: "Ultrasound therapy device macro board close up"
  },
  {
    id: 2,
    ...
    imageSrc: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80", // Robot near wall: abstract machine association
    altText: "Electrotherapy interferential current machine abstract"
  },
  {
    id: 3,
    ...
    imageSrc: "https://images.unsplash.com/photo-1523712999610-f77fbcfc3843?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80", // Forest beams: wellness/active lifestyle
    altText: "Forest sunlight wellness scene"
  },
  {
    id: 4,
    title: "TENS Therapy",
    ...
    imageSrc: "https://images.unsplash.com/photo-1518770660439-4636190af475?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80", // Use the same macro machine/board as above for "electrical" association
    altText: "TENS therapy, illustrative electronics"
  },
  {
    id: 5,
    ...
    imageSrc: "https://images.unsplash.com/photo-1482938289607-e9573fc25ebb?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80", // River between mountains, symbolizes journey & recovery
    altText: "Consultation and rehabilitation journey wellness"
  },
  {
    id: 6,
    ...
    imageSrc: "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80", // Zen/orange flowers: calming, therapeutic
    altText: "Manual therapy healing environment"
  },
];
