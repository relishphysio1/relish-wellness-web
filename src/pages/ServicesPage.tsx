...
const services = [
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?ixlib=rb-4.0.3&auto=format&fit=crop&w=750&q=80", // Physical therapist performing ultrasound therapy with handheld device
  ...
  },
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=750&q=80", // Physiotherapist applying electrical stimulation electrodes to patient
  ...
  },
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=750&q=80", // Patient doing guided exercise therapy with physiotherapist
  ...
  },
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1559757175-0eb30cd8c063?ixlib=rb-4.0.3&auto=format&fit=crop&w=750&q=80", // TENS therapy electrodes applied to patient's back with unit visible
    altText: "TENS therapy electrodes applied to patient's lower back with physiotherapist monitoring"
  },
  {
    id: 5,
    ...
    imageSrc: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&auto=format&fit=crop&w=750&q=80", // Physiotherapist consulting with patient, checking posture and range of motion
  ...
  },
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-4.0.3&auto=format&fit=crop&w=750&q=80", // Physiotherapist performing manual therapy and massage on patient's back
