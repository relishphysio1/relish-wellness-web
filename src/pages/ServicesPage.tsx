...
const ServicesPage = () => {
  const services = [
    ...
    },
    {
      ...
      imageSrc: "https://images.unsplash.com/photo-1579154392429-b05c666d4e66?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80",
    ...
    },
    {
      ...
      altText: "Physical therapist guiding patient through exercise"
    },
    {
      id: 4,
      title: "TENS Therapy",
      ...
      imageSrc: "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80",
    ...
    },
    {
      ...
      imageSrc: "https://images.unsplash.com/photo-1598259065881-69a5f19d3701?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80",
